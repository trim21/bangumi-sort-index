...
function bangumiSortIndex() {
  ...
  function getDate(rel) {
    ...
    const castDate = Array.from(((_document$querySelect = document.querySelector(rel)) === null || _document$querySelect === void 0 ? void 0 : (_document$querySelect2 = _document$querySelect.querySelector('span.tip')) === null || _document$querySelect2 === void 0 ? void 0 : _document$querySelect2.childNodes) ?? []).filter(e => e.nodeType === Node.TEXT_NODE).map(e => e.textContent ?? '').filter(t => t.includes(castKeyword));
...
<li data-mode='smart' ><a href='javascript:void(0);' id='switchSmartOrder'  title='智障順序'><span>智能</span></a></li>
    ...
    function click() {
      ...
      if (this) {
        ...
        mode = (_el$data = el.data('mode')) === null || _el$data === void 0 ? void 0 : _el$data.toString();
